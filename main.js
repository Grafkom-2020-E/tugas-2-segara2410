function main() {
  ...
  // -0.45, -0.1, 0.0, 0.66, 0.88,
  // 0.0, -0.8, 0.6, 0.8, 0.88,
  // -0.2, -0.8, 0.6, 0.8, 0.88,
  // -0.65, -0.1, 0.0, 0.66, 0.88,
  // -0.725, -0.1, 0.0, 0.66, 0.88,
  // -0.75, -0.15, 0.0, 0.66, 0.88,
  // -0.75, -0.8, 0.0, 0.66, 0.88,
  // -0.95, -0.8, 0.0, 0.66, 0.88,
  // -0.95, 0.8, 0.0, 0.4, 0.6,
  // -0.2, 0.8, 0.0, 0.4, 0.6,
  // -0.05, 0.65, 0.0, 0.66, 0.88,
  // -0.05, 0.05, 0.0, 0.66, 0.88,
  // -0.2, -0.1, 0.0, 0.66, 0.88,
  var vertices = [];
  var cubePoints = [
    [-0.925, -0.8,  0.8], // 0
    [-0.925,  0.8,  0.8], // 1
